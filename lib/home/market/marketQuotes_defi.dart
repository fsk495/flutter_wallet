...
class MarketQuotesMarketValue extends StatefulWidget {
  const MarketQuotesMarketValue({super.key});

  @override
  _MarketQuotesMarketValueState createState() => _MarketQuotesMarketValueState();
}

class _MarketQuotesMarketValueState extends State<MarketQuotesMarketValue> {
